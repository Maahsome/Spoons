...
mkdir -p .docs_tmp
/usr/bin/python3 "${HAMMERSPOON_PATH}/scripts/docs/bin/build_docs.py" -e "${HAMMERSPOON_PATH}/scripts/docs/templates/" -o .docs_tmp -i "Maahsome Hammerspoon Spoons" -u "https://github.com/Maahsome/Spoons/blob/main/" -j -t -n Source
